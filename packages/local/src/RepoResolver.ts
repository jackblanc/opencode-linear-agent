 ...
 *
 * Strategy:
 * 1. Check issue attachments for GitHub repo links
 * 2. Check issue's project for GitHub integration
 * 3. Fall back to default repo
 */
...
export class RepoResolver {
  ...
  async resolve(issueId: string): Promise<ResolvedRepo | null> {
    ...
    try {
      ...
      // Strategy 1: Check attachments for GitHub links
      ...
      // Strategy 2: Check issue description for GitHub links
      ...
      // Strategy 3: Fall back to default repo

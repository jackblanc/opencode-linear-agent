    ...
    linear_update_issue: tool({
      ...
      args: {
        ...
        state: z
          ...
          .optional()
          .describe(
            "State name, type, or ID (e.g. 'In Progress', 'completed')",
          ),
        assignee: z
          .string()
          .optional()
        ...
        blocks: z
          ...
          .optional()
          .describe(
            "Issue IDs/identifiers this issue blocks. Replaces existing",
          ),
        blockedBy: z
          .array(z.string())
          .optional()
    ...
    linear_create_issue: tool({
      ...
      args: {
        ...
        parentId: z
          .string()
          .optional()
          .describe("Parent issue ID or identifier"),
        blocks: z
          .array(z.string())
          .optional()
